...
class MatchingAlgo {
    ...
    var persons = [
        Person(name: "Michael",
               characteristics: [.age: 22, .gender: "M", .civilStatus: "single", .hometown: "San Francisco"],
               interest: [.Climbing, .Travel, .Motocycle, .Movie]),
        
        
        
        
        
        Person(name: "Laura", characteristics: [.age: 25, .gender: "F", .civilStatus: "single", .hometown: "Rome"], interest: [.Cooking, .Travel, .Books, .Movie]),
        Person(name: "Mark", characteristics: [.age: 37, .gender: "M", .civilStatus: "married", .hometown: "Sydney"], interest: [.Photo, .Travel, .Motocycle, .Movie]),
        Person(name: "Janice", characteristics: [.age: 18, .gender: "F", .civilStatus: "single", .hometown: "New York"], interest: [.Fashion, .Movie, .Photo, .Running, .Travel,.Cooking]),
        Person(name: "Jessica", characteristics: [.age: 30, .gender: "F", .civilStatus: "married", .hometown: "Dublin"], interest: [.Movie, .Running, .Climbing, .Motocycle, .Travel])
    ]
    ...
    private init() {
        ...
        //get random numer of persons and add it to people
